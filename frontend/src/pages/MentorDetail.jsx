...
function MentorDetail() {
      ...
      <div className="animate-pulse space-y-6">
        <div className="flex items-center gap-6">
          ...
          <div className="space-y-3 flex-1">
            <div className="h-8 bg-white/[0.04] rounded-full w-1/3" />
            <div className="h-5 bg-white/[0.03] rounded-full w-1/4" />
          </div>
        </div>
    ...
    return (
      <div className="text-center py-20 flex flex-col items-center">
        <div className="w-16 h-16 rounded-full bg-white/[0.03] border border-white/[0.06] flex items-center justify-center mb-6">
          <Crosshair className="w-7 h-7 text-zinc-600" strokeWidth={1.5} />
        </div>
        <h2 className="text-xl font-bold text-white mb-4 tracking-tight">{error || 'Mentor not found'}</h2>
  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      {/* Back Link */}
      <Link to="/mentors" className="text-zinc-600 hover:text-white flex items-center gap-2 text-sm transition-colors w-fit">
      ...
      <div className="glass-elevated rounded-2xl p-8 md:p-10 relative overflow-hidden animate-fade-in">
        ...
        <div className="absolute top-0 right-0 w-80 h-80 bg-indigo-500/[0.06] rounded-full blur-[120px] pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-80 h-80 bg-purple-500/[0.05] rounded-full blur-[120px] pointer-events-none" />

        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-8">
          <div className="relative shrink-0">
            <div className="w-28 h-28 rounded-full bg-white/[0.02] border border-white/[0.08] flex items-center justify-center text-white font-bold text-4xl shadow-2xl shadow-black/50 backdrop-blur-xl relative z-10">
              {initials}
            </div>
          ...
          <div className="flex-1">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-3 tracking-tight leading-[1.1]">{fullName}</h1>
            <p className="text-zinc-500 text-lg mb-5">
              {mentor.domain} at <span className="text-zinc-300 font-medium">{mentor.company}</span> {'\u00B7'} {mentor.experience_years}+ years
            </p>
            <div className="flex flex-wrap gap-1.5">
              ...
              <span className="badge border-white/[0.06] bg-white/[0.03] text-zinc-400">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 flex flex-col gap-8">
          ...
          <div className="glass-surface rounded-2xl p-7 md:p-8 animate-fade-in-d1">
            <h2 className="text-xs font-bold text-zinc-600 mb-8 uppercase tracking-widest flex items-center gap-2.5">
              <TrendingUp className="w-3.5 h-3.5 text-indigo-400/70" strokeWidth={2} /> Their Journey
            </h2>
                ...
                return (
                  <div key={index} className="flex gap-5 group relative">
                    ...
                    {index < journeySteps.length - 1 && (
                      <div className="absolute top-14 left-5 w-px h-[calc(100%-1rem)] border-l border-dashed border-white/[0.08] group-hover:border-indigo-500/30 transition-colors duration-500" />
                    )}
                    {/* Timeline Icon */}
                    <div className="relative z-10 flex flex-col items-center">
                      <div className="w-10 h-10 rounded-full bg-[#09090b] border border-white/[0.08] flex items-center justify-center shrink-0 shadow-lg shadow-black/40 ring-4 ring-[#09090b] group-hover:border-indigo-500/40 group-hover:bg-indigo-500/5 transition-all duration-300">
                        <StepIcon className="w-4 h-4 text-zinc-400 group-hover:text-indigo-400 transition-colors duration-300" strokeWidth={1.8} />
                      </div>
                    </div>
                    {/* Content */}
                    <div className="pb-10 pt-1">
                      <h3 className="text-white font-bold mb-1.5 text-lg tracking-tight group-hover:text-indigo-200 transition-colors duration-300">{step.title}</h3>
                      <p className="text-zinc-500 text-sm leading-relaxed max-w-2xl">{step.description}</p>
                    </div>
                  </div>
                )
              })}
          ...
          <div className="glass-surface rounded-2xl p-7 md:p-8 animate-fade-in-d2">
            <h2 className="text-xs font-bold text-zinc-600 mb-8 uppercase tracking-widest flex items-center gap-2.5">
              <Crosshair className="w-3.5 h-3.5 text-cyan-400/70" strokeWidth={2} /> Why they are right for you
            </h2>
            <ul className="space-y-5">
              {mentor.previous_college_tier === '3' && (
                <li className="flex items-start gap-4">
                  <span className="w-6 h-6 rounded-full bg-indigo-500/[0.03] border border-indigo-500/20 flex items-center justify-center shrink-0 mt-0.5">
                    <Check className="w-3.5 h-3.5 text-indigo-400" strokeWidth={2} />
                  </span>
                  <p className="text-zinc-500 text-sm leading-relaxed">
                    <span className="text-zinc-200 font-medium">Came from a Tier 3 college</span> — they understand the challenges of limited campus placements and the hustle of self-learning.
                  </p>
                </li>
              )}
              {mentor.previous_college_tier === '2' && (
                <li className="flex items-start gap-4">
                  ...
                  <p className="text-zinc-500 text-sm leading-relaxed">
                    <span className="text-zinc-200 font-medium">Came from a Tier 2 college</span> — they know what it's like to compete against Tier 1 peers and how to stand out.
                  </p>
                </li>
              )}
              {mentor.internship_status === 'none' && (
                <li className="flex items-start gap-4">
                  ...
                  <p className="text-zinc-500 text-sm leading-relaxed">
                    <span className="text-zinc-200 font-medium">Had no initial internship</span> — they didn't have early opportunities, but still broke in. They can show you how.
                  </p>
                </li>
              )}
              {mentor.internship_status === 'startup' && (
                <li className="flex items-start gap-4">
                  ...
                  <p className="text-zinc-500 text-sm leading-relaxed">
                    <span className="text-zinc-200 font-medium">Started with a startup internship</span> — they took an unconventional route and can guide you on making the most of it.
                  </p>
                </li>
              )}
              <li className="flex items-start gap-4">
                ...
                <p className="text-zinc-500 text-sm leading-relaxed">
                  <span className="text-zinc-200 font-medium">Now at {mentor.company}</span> — proof that the starting point doesn't define the destination.
                </p>
              </li>
            </ul>
          </div>
        ...
        <div className="flex flex-col gap-8">
          <div className="glass-surface rounded-2xl p-7 animate-fade-in-d2">
            <div className="flex items-center justify-between mb-7 pb-5 border-b border-white/[0.04]">
              <h2 className="text-xs font-bold text-zinc-600 uppercase tracking-widest flex items-center gap-2.5">
                <Star className="w-3.5 h-3.5 text-amber-400/70" strokeWidth={2} /> Reviews
              </h2>
              <div className="flex items-center gap-1.5">
                <Star className="w-4 h-4 text-amber-400" strokeWidth={2} fill="currentColor" />
                <span className="text-amber-400 text-lg font-bold">{mentor.average_rating > 0 ? mentor.average_rating.toFixed(1) : '-'}</span>
                <span className="text-zinc-600 text-xs">({mentor.total_reviews})</span>
              </div>
            </div>
                ...
                {reviews.map(review => (
                  <div key={review.id} className="group">
                    <div className="flex items-center gap-0.5 mb-2">
                      {[...Array(5)].map((_, i) => (
                        <Star key={i} className={`w-3 h-3 ${i < review.rating ? 'text-amber-400' : 'text-white/[0.06]'}`} strokeWidth={0} fill="currentColor" />
                      ))}
                    </div>
                    {review.comment && <p className="text-zinc-400 text-sm leading-relaxed mb-2">"{review.comment}"</p>}
                    <div className="flex items-center gap-2 text-xs">
                      <span className="text-zinc-300 font-medium">{review.mentee_name}</span>
                      <span className="text-zinc-700">&bull;</span>
                      <span className="text-zinc-600">{new Date(review.created_at).toLocaleDateString()}</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            {eligibleSession && (
              <div className="mt-7 pt-5 border-t border-white/[0.04]">
                <button onClick={() => setShowReviewModal(true)} className="w-full btn-secondary py-3 rounded-xl text-sm font-medium flex items-center justify-center gap-2">
                  <Star className="w-4 h-4 text-amber-400/80" strokeWidth={2} /> Leave a Review
                </button>
              </div>
            )}
          </div>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-50 px-4" onClick={(e) => e.target === e.currentTarget && !sending && setShowModal(false)}>
          <div className="glass-floating rounded-2xl p-8 md:p-10 w-full max-w-lg animate-fade-in relative overflow-hidden">
             {/* Decorative glow */}
             <div className="absolute top-0 right-0 w-64 h-64 bg-indigo-500/[0.06] rounded-full blur-[100px] pointer-events-none" />
            ...
            {sent ? (
              <div className="text-center py-6 relative z-10">
                ...
                <h3 className="text-2xl font-bold text-white mb-3 tracking-tight">Request Sent</h3>
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="flex justify-center gap-2 mb-7">
                {[1, 2, 3, 4, 5].map(star => (
                  ...
                  >
                    <Star
                      className={`w-8 h-8 transition-colors duration-300 ${reviewRating >= star ? 'text-amber-400 drop-shadow-[0_0_8px_rgba(251,191,36,0.3)]' : 'text-white/[0.06] hover:text-amber-400/30'}`}
                      strokeWidth={0}
                      fill="currentColor"
                    />
                  </button>
